...
exports.DocumentsGroup = exports.applyGroupByLocally = void 0;
var utils_1 = require("../utils");
function applyGroupByLocally(documents, astGroupBy) {
    (0, utils_1.assert)(astGroupBy.length > 0, 'GROUP BY needs at least 1 group.');
    var group = new DocumentsGroup();
    group.documents = documents;
    astGroupBy.forEach(function (groupBy) {
        (0, utils_1.assert)(groupBy.type === 'column_ref', 'GROUP BY only supports grouping by field names.');
...
function applySingleGroupBy(documents, groupBy) {
    ...
    if (documents instanceof DocumentsGroup) {
        ...
        for (var i = 0; i < numDocs; i++) {
            ...
            var groupValue = String((0, utils_1.safeGet)(doc, groupBy.column));
            if (!(0, utils_1.contains)(groupedDocs, groupValue)) {
